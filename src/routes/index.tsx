    ...
    <main className="min-h-screen bg-background px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-6xl">
       <header className="mb-8">
          {/* Original pale overline */}
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
            Crypto taxes
          </p>
          
          {/* Title and Tooltip on the same row */}
            ...
            <div className="relative group inline-block">
              ...
              <div className="absolute left-0 top-full mt-2 w-80 p-4 bg-card border border-border rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 text-xs text-foreground">
                ...
                <p className="font-medium text-foreground">
                  Pro tip: <span className="text-muted-foreground font-normal">Experiment with different combinations of your holdings to optimize your tax liability</span>
                </p>
              </div>
            </div>
          </div>

          {/* Original pale description text */}
          ...
          <details className="bg-card border border-border rounded-xl group cursor-pointer overflow-hidden">
            <summary className="flex items-center p-4 text-sm font-medium text-foreground list-none hover:bg-white/5 transition-colors">
              ...
              <svg className="w-4 h-4 ml-auto text-muted-foreground transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="px-11 pb-5 text-xs text-muted-foreground space-y-3 bg-card pt-2">
              ...
              <p>
                <strong className="text-foreground font-semibold">Country-specific Availability:</strong> Tax loss harvesting may not be supported in all countries. We strongly recommend consulting with your local tax advisor or accountant before performing any related actions on your exchange.
              </p>
              <p>
                <strong className="text-foreground font-semibold">Utilization of Losses:</strong> Tax loss harvesting typically allows you to offset capital gains. However, if you have zero or no applicable crypto capital gains, the usability of these harvested losses may be limited. Kindly confirm with your tax advisor how such losses can be applied in your situation.
              </p>
            </div>
          </details>
        </header>
